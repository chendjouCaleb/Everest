...
public enum StatusCode {
     ...
     * @deprecated in favor of {@link #FOUND} which will be returned from {@code StatusCode.valueOf(302)}
     */
    @Deprecated
    ...
    /**
     * {@code 413 HttpRequest Entity Too Large}.
     *
     ...
     * returned from {@code StatusCode.valueOf(413)}
     */
    @Deprecated
    REQUEST_ENTITY_TOO_LARGE(413, "HttpRequest Entity Too Large"),
    /**
    ...
    /**
     * {@code 414 HttpRequest-URI Too Long}.
     *
     * @see <a href="http://tools.ietf.org/html/rfc2616#section-10.4.15">HTTP/1.1, section 10.4.15</a>
     * @deprecated in favor of {@link #URI_TOO_LONG} which will be returned from {@code StatusCode.valueOf(414)}
     */
    @Deprecated
    REQUEST_URI_TOO_LONG(414, "HttpRequest-URI Too Long"),
    /**
    ...
    /**
     * {@code 431 HttpRequest Header Fields Too Large}.
     *
     * @see <a href="http://tools.ietf.org/html/rfc6585#section-5">Additional HTTP Status Codes</a>
     */
    REQUEST_HEADER_FIELDS_TOO_LARGE(431, "HttpRequest Header Fields Too Large"),
    /**
    ...
    /**
     * Resolve the given status code to an {@code StatusCode}, if possible.
     *
