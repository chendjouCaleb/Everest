...
public class StringUtils {
    ...
    public static String ucFist(String string) {
        return string.substring(0, 1).toUpperCase() + string.substring(1);
    }

    public static String lowerFist(String string) {
        return string.substring(0, 1).toLowerCase() + string.substring(1);
    }

    public static String addSlashBefore(String str){
        if(!str.startsWith("/"))
            return "/"+str;
        return str;
    }

    public static String addSlashAfter(String str){
        if(!str.endsWith("/"))
            return str + "/";
        return str;
    }

    public static String removeSlashBefore(String str){
        if(!str.startsWith("/"))
            return str;
        return str.substring(1);
    }

    public static String removeSlashAfter(String str){
        if(!str.endsWith("/"))
            return str;
        return str.replaceAll("/$", "");
    }
    public static String trim(String str, String border){
        return str.replaceAll("^"+border, "").replaceFirst(border+"$", "");
    }
