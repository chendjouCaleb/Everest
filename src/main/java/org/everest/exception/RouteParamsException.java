...
public class RouteParamsException extends Exception{
     ...
     */
    public RouteParamsException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public RouteParamsException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public RouteParamsException(Throwable cause) {
        super(cause);
    }
}
